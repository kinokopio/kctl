...
func ProbePort(ip string, port int, timeout time.Duration) *types.ProbeResult {
...
func ValidateKubeletPort(ip string, port int, token string, timeout time.Duration) *types.ProbeResult {
	result := &types.ProbeResult{
		IP:   ip,
		Port: port,
	}
